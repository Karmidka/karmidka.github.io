...
<script src="https://www.google.com/recaptcha/api.js?render=<6Le7mKQaAAAAADxGVVtKaMOZzZKQyGYx3C1cW900>"></script>
<script>
grecaptcha.ready(function () {
  grecaptcha.execute('<6Le7mKQaAAAAADxGVVtKaMOZzZKQyGYx3C1cW900>', { action: 'contact' }).then(function (token) {
